...
import com.softtanck.tangce.pclcolortest.translator.PngTranslator;
...
public abstract class USBPrinter {
    ...
    /**
     * Return a byte array that has the bytes corresponding to printer commands
     * to print the image file that is saved in the "fileData" byte array.
     *
    ...
    /**
     * Add to the printer data stream the bytes corresponding to the commands
     * for setting the position given where the image will be placed on the
     * page.
     */
    ...
    /**
     * Add the byte representation of a decimal number to the printer byte data
     * stream.
     *
    ...
    /**
     * Add the byte representation of an integer number to the printer byte data
     * stream.
     *
    ...
    /**
     * Add to the byte data stream the characters corresponding to the Universal
     * Exit Language (UEL) and selects a specific language to send the
     * instruction set to the printer.
     *
     * @param language The Language that will be used to send the instruction set to
     *                 the printer.
     */
    public void addUEL(String language) { // Universal Exit Language, control to
        // PJL
        addESC();
        addText("%-12345X");
    ...
    /**
     * Set the position where the image will be placed on the page. The meaning
     * of this values (orientation in page) may vary with different types of
     * Page Descriptor Languages (like PostScript or PCL)
     *
    ...
    /**
     * Set the scaling to apply on the image. This scaling is specified with
     * values for width and height scale.
     *
